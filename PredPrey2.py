...
def runSim(n_pred, n_prey, speed, width, length, n_steps,
    ...
    for i in range(n_prey):
        preyList.append(Prey(speed, s_health-50, gain, s_rep_health, width, length))
...
n_pred = 100; n_prey = 120; speed = 1; width = 70; length = 70; n_steps = 5000;
s_health = 100; w_rep_health = 140; s_rep_health = 70; loss = 1; gain = 2.5;
